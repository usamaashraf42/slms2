		...
		<div class="col-md-12 col-sm-12 col-lg-12 col-xl-12">
			<div class="card-box">
				<div class="card-block">
					...
					@endcomponent
					<form method="POST" action="{{ route('exam-category.store') }}" enctype = "multipart/form-data" id="upload_new_form">
						<div class="col-md-12">
							{{csrf_field()}}
							<div class="row">
								<div class="col-md-3">
									<div class="form-group">
										...
										<input class="term" name="term"  id="term"  style="width: 100%;height: 40px;">
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<select class="parent_id" name="parent_id"  id="parent_id"  style="width: 100%;height: 40px;">
											...
											<option value={{$branch['id']}}>{{$branch['term']}}</option>
											@endforeach
											@endif
										</select>
