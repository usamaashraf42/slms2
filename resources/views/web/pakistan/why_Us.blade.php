        ...
        <div class="swRotator swSlider " id="swSlider-298972">
            <div class="scrollable" style="height: 607px; width: 100%;">
                ...
                <div class="item" id="banner-element-43151" style="height: 607px; width: 1903px; float: left; background-image: url({{asset('assets/frontend/images/about.jpg')}});">
                    ...
                    <img src="{{asset('assets/frontend/images/steps.jpg')}}" alt="Pep Rally" class="o-0">
                ...
                <div class="item" id="banner-element-43152" style="height: 607px; width: 1903px; float: left; background-image: url({{asset('assets/frontend/images/mainslider(5).jpg')}});">
                    ...
                    <img src="#" alt="Teaching at Lyceum" class="o-0">
...
<section class="default-main content-start relative bg-white">
    ...
    <div class="breadcrumb-container w-100 pa3 pv2-ns ph4-ns relative">
        ...
        <ul id="breadcrumb"><li id="bc-home">About <aclass="first"></a></li><li id="bc-about"> <a  class="current">Why us</a></li></ul>
    ...
    <div class="flex flex-row-ns flex-column flex-wrap mw8 center relative">
        ...
        <div class="main-section w-70-l w-70-m w-100 ph4 ph0-l">
            <div class="w-100">
                ...
                <h1 class="mt5-ns pr4-ns hidden-element fade-down element-load">Why us</h1>
            ...
            <script type="text/javascript">
                ...
                <div class="templatecontent ">
                    <p>By joining our network, you will be assured that you have made the right choice. The benefits include in the investment makes the management easier for any franchise holder with following facilitis:</p>
                    <h6>"United We Stand ,Divided We Fall"</h6>
                    

                </div>

                <div id="accordion-696" class="sw-accordion ui-accordion ui-widget ui-helper-reset ui-accordion-icons" role="tablist">

                    <h3 class="tabbedcontent-header ui-accordion-header ui-helper-reset ui-state-default ui-corner-all" role="tab" aria-expanded="true" aria-selected="true" tabindex="0"><span class="ui-icon ui-icon-triangle-1-e"></span>Why American Lyceum International School</h3>
                    <div class="tabbedcontent-content ui-accordion-content ui-helper-reset ui-widget-content ui-corner-bottom" style="overflow: hidden; display: none;" role="tabpanel">

                     <ul>
                         <li>International Brand Recognition</li>
                         <li>Whole brain Teaching (WBT)/ Power Teaching</li>
                         <li>Standardized Syllabus and Curriculum Academic Planning</li>
                         <li>Study planners</li>
                         <li>Faculty Training (at franchisee cost)</li>
                         <li>School management Software</li>
                         <li>International Workshops</li>
                         <li>Inter Branch transfer facility</li>
                         <li>Logistic Support</li>
                         <li>Handsome profits </li>
                         <li>Secure Investment</li>
                         <li>Can Reserve your area</li>
                         <li>Quality Assurance Support</li>
                         <li>International Residency (Conditions apply)</li>
                         <li>Payback option (for Investment Franchise Only</li>
                         <li>Elevated Status as an Educationist</li>
                         <li>Convert your Life into a mission</li>
                         <li>Branch Transfer</li>
                     </ul>
             ...
             <div id="accordion-696" class="sw-accordion ui-accordion ui-widget ui-helper-reset ui-accordion-icons" role="tablist">
                ...
                <h3 class="tabbedcontent-header ui-accordion-header ui-helper-reset ui-state-default ui-corner-all" role="tab" aria-expanded="true" aria-selected="true" tabindex="0"><span class="ui-icon ui-icon-triangle-1-e"></span>Who Are We</h3>
                <div class="tabbedcontent-content ui-accordion-content ui-helper-reset ui-widget-content ui-corner-bottom" style="overflow: hidden; display: none;" role="tabpanel">
