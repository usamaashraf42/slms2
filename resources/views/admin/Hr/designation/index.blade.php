	...
	<div class="row">
      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-sm-8">
              <h4 class="page-title">Designation Mangement</h4>
            </div>
            <div class="col-sm-4 text-right m-b-30">
              <a href="{{route('designation.create')}}" class="btn btn-primary rounded" ><i class="fa fa-plus"></i> Add New </a>
            </div>
          </div>
          <br>
...
<script>
  ...
  $('#category_table').DataTable( {
    ...
    ajax: {
      ...
      "url":"<?= route('designation.SearchAjax') ?>",
      "dataType":"json",
      "type":"POST"
    },
    columns:[
    ...
    {"data":"id","render":function(id){
      var edit_route = '{{ route("designation.edit", ":id") }}';
