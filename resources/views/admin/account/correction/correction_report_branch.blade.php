...
@section('title', 'Correction Approved')
@section('content')
		...
		<div class="col-md-12 col-sm-12 col-lg-12 col-xl-12">
			<div class="card-box">
				<div class="card-block">
					<h4 class="card-title">Correction Approved</h4>
					
					@component('_components.alerts-default')
					@endcomponent
					<form method="POST" action="{{ route('branch_correction_report') }}" enctype = "multipart/form-data" id="upload_new_form">
								<div class="col-md-12">
									{{csrf_field()}}
									<div class="row">
									<div class="col-md-5">
										<div class="form-group">
											...
											<select class="form-control-1 branch_id" name="branch_id" onchange="getClass(this)"  id="select_branch" required style="height: 40px; width: 100%;">
										...
										<div class="row">
											...
											<div class="col-md-4">
												<div class="form-group">
													...
													<select type="text" class="form-control type" id="type"   name="type"  ">
