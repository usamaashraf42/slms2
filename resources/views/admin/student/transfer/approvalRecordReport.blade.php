	...
	<div class="row">
        ...
        <div id="printAllRecord" >
				<div class="card-block">
					<h4 class="card-title">Stduent Transfer </h4>
             ...
             @isset($transfers)
              ...
              @if($classId!=$class)
                  ...
                  <tr class="correctionRow{{$pro->id}}">
                    <input type="hidden" name="" class="transfer{{$pro->id}}" value="{{$pro->id}}">
...
<script type="text/javascript">
   function unapproveRequest(id){
         ...
         $.ajax({
            url: "admin/student/transfer" + '/' + id + '/edit', 
            method:"GET",
        ...
        function approveRequest(id){
          ...
          var transfer=$('.transfer'+id).val();

            console.log('query_params',transfer);

         $.ajax({
            url: "{{route('approval-transfer-student.store')}}", 
            method:"POST",
            data:{id:transfer},
            success: function(response){
