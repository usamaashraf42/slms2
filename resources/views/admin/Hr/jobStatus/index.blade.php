			...
			<div class="card-box">
				...
				<div class="card-block">
					...
					<div class="heading-elements float-right">
                        <a href="{{route('application-status.create')}}">
                        	<button type="button" class="btn btn-success btn-min-width mr-1 mb-1">
                        		<i class="la la-plus">&nbsp;Add New</i>
                        	</button>
                    	</a>
                    </div>
							...
							<tbody>
								@isset($applications)
									...
									<tr>
										...
										<td>@isset($application->name){{$application->name}}@endisset</td>
										...
										<td><a href="{{route('application-status.edit',$application->id)}}"  class="btn btn-info btn-sm">Edit</a></td>
									</tr>
									@endforeach
								@endisset
							</tbody>
...
<script>
	...
	function deleteItem(id) {
		...
		if (val) {
			$.ajax({
				url: "{{route('deleteApplicationStatus')}}",
				type: 'post',
				data: {
					'id': id
				},
