		...
		<div class="col-md-12 col-sm-12 col-lg-12 col-xl-12">
			<div class="card-box">
				<div class="card-block">
					...
					@endcomponent
					<form method="POST" action="{{ route('bank.store') }}" enctype = "multipart/form-data" id="upload_new_form">
						<div class="col-md-12">
							{{csrf_field()}}
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" class="form-control bank_name" value="{{old('bank_name')}}" name="bank_name" id="bank_name" placeholder="Account Category Name">
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<input name="account_no" type="text" value="{{old('account_no')}}" class="form-control" placeholder="School Name">
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<input name="cont_no" type="text" value="{{old('cont_no')}}" class="form-control" placeholder="School Name">
