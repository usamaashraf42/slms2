<?php
include('_layouts/admin.fpdf.php');
...
$pdf->image('download.jpg',20,10,35,35);
//upper cell with border

/*end of line*/
//Array for another loop
$pdf->SetDrawColor(229,223,209);
...
$pdf->cell('5',15,'',0,1);
//Image logo
$pdf->image('download.jpg',10,134,18,20);
$pdf->SetX(30);
$pdf->setFillColor(120,173,181);
$pdf->SetTextColor(255,255,255);
...
$pdf->cell('5',10,'',0,1);
//Image logo
$pdf->image('download.jpg',10,203,18,20);
$pdf->SetX(30);
$pdf->setFillColor(120,173,181);
$pdf->SetTextColor(255,255,255);
$pdf->SetDrawColor(255, 255, 255);
