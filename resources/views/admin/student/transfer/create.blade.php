		...
		<div class="col-md-12 col-sm-12 col-lg-12 col-xl-12">
			<div class="card-box">
				<div class="card-block">
					<h4 class="card-title">Student Transfer</h4>
					
					@component('_components.alerts-default')
					@endcomponent
					<form method="POST" action="{{ route('transfer.store') }}" enctype = "multipart/form-data" id="upload_new_form">
						<div class="col-md-12">
							{{csrf_field()}}
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											...
											<select type="text" class="form-control student_id" id="student_id"   name="student_id"  placeholder="Student Name"style="width: 100%;height: 35px;">
											</select>
										</div>
							...
							<div class="col-md-10">
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<label for="to_branch_id"> Transfer Select Branch</label>
											<select class="to_branch_id" id="to_branch_id" name="to_branch_id" onchange="getCourse(this)"   required style="    width: 100%;
											height: 35px;">
											<option selected="selected" disabled="disabled">All Branches</option>
								...
								<div class="col-md-6">
									<div class="form-group">
										<label for="to_class_id">Select Class</label>
										<select type="text" class="form-control to_class_id" id="to_class_id"  name="to_class_id"  placeholder="Name">
											<option selected="selected" disabled="disabled">Seclect Class</option>
						...
						<div class="col-md-10">
							...
							<textarea class="description" id="description" name="description"  style="    width: 100%;
							height: 35px;">
							</textarea> 
