		...
		<div class="col-md-12 col-sm-12 col-lg-12 col-xl-12">
			<div class="card-box">
				<div class="card-block">
					...
					@endcomponent
					<form method="POST" action="{{ route('edit-student.store') }}" enctype = "multipart/form-data" id="upload_new_form">
						<div class="col-md-12">
							{{csrf_field()}}
								...
								<div class="row"> 
									<div class="col-md-4">
										<div class="form-group">
											...
											<select class="branch_id" name="branch_id" onchange="getClass(this)"  id="branch_id" required style="width: 100%;height: 35px;">
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<select type="text" class="class_id" id="class_id" onchange="getStudent()"  name="class_id"  placeholder="Name"style="width: 100%;height: 35px;">
