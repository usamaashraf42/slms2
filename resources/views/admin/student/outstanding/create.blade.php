		...
		<div class="col-md-12 col-sm-12 col-lg-12 col-xl-12">
			<div class="card-box">
				<div class="card-block">
					...
					@endcomponent
					<form method="POST" action="{{ route('outstanding.store') }}" enctype = "multipart/form-data" id="upload_new_form">
								<div class="col-md-12">
									{{csrf_field()}}
									<div class="row"> 
									<div class="col-md-5">
										<div class="form-group">
											...
											<select class="branch_id" name="branch_id" onchange="getClass(this)"  id="select_branch" required style="height: 40px; width: 100%;">
									...
									<div class="col-md-5">
										<div class="form-group">
											...
											<select type="text" class="class_id" id="class_id" onchange="getStudent()"  name="class_id"  placeholder="Name"style="height: 40px; width: 100%;">
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													...
													<select type="text" class="student_id" id="student_id"   name="student_id"  placeholder="Student Name"style="height: 40px; width: 100%;">
													</select>
												</div>
											...
											<div class="col-md-6">
												<div class="form-group">
													<label for="ly_no">Lyceonion No</label>
													<input type="text" class="ly_no" id="ly_no"   name="ly_no"  placeholder="Student Name"style="height: 40px; width: 100%;"> 
												</div>                       
											</div>
										</div>
									</div>
