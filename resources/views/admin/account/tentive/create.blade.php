...
@section('title', 'Tentive List')
@section('content')
<div class="content container-fluid">
	<div class="row">

		<div class="col-md-12 col-sm-12 col-lg-12 col-xl-12">
			<h4 class="card-title">Tentive List</h4>
			<div class="card-box">
				...
				<div class="card-block">
					...
					@endcomponent
					<form method="POST" action="{{ route('tentive.store') }}" enctype = "multipart/form-data" id="upload_new_form">
						<div class="col-md-12">
							{{csrf_field()}}
							<div class="row">
								<div class="col-md-5">
								...
								<div class="col-md-5">
									<div class="form-group">
										...
										<select type="text" class="class_id" id="class_id" onchange="getStudent()"  name="class_id"  placeholder="Name" style="width: 100%;height: 40px;">
