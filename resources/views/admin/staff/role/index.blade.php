							...
							<tbody>
								@isset($roles)
									...
									<tr>
										...
										<td>
											@if($role->status)
												<a href="javascript:;" onclick="deleteItem({{$role->id}})"  class="btn btn-success btn-sm">Active</a> 
											@else 
												<a href="javascript:;" onclick="deleteItem({{$role->id}})" class="btn btn-warning btn-sm">Deactive</a> @endif
												
										</td>
										<td><a href="{{route('role.edit',$role->id)}}"  class="btn btn-info btn-sm">Edit</a></td>
									</tr>
									@endforeach
								@endisset
							</tbody>
