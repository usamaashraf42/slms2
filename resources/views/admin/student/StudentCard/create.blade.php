		...
		<div class="col-md-12 col-sm-12 col-lg-12 col-xl-12">
			<div class="card-box">
				<div class="card-block">
					<h4 class="card-title">Student Card</h4>
					
					@component('_components.alerts-default')
					@endcomponent
					<form method="POST" action="{{ route('card.store') }}" enctype = "multipart/form-data" id="upload_new_form">
						<div class="col-md-12">
							{{csrf_field()}}
							<div class="row">
								<div class="col-md-5">
							...
							<div class="row">
								<div class="col-md-5">
									<div class="form-group">
										...
										<select type="text" class="form-control student_id" id="student_id"   name="student_id"  placeholder="Student Name">
										</select>
									</div>
								...
								<div class="col-md-5">
									<div class="form-group">
										...
										<select type="text" class="category" value="{{old('ly_no')}}" name="student_id" id="account" placeholder="cat_id" style="width: 100%;min-height: 40px;">
