		...
		<div class="col-md-12 col-sm-12 col-lg-12 col-xl-12">
			<div class="card-box">
				<div class="card-block">
					<h4 class="card-title">Cash Receipt</h4>
					
					@component('_components.alerts-default')
					@endcomponent
					<form method="POST" action="{{ route('cash-receipt.store') }}" enctype = "multipart/form-data" id="upload_new_form">
						<div class="col-md-12">
							{{csrf_field()}}
							<div class="row">
								<div class="col-md-6">
									...
									<div  style="float: right; clear: both;"> <button type="button" class="btn btn-success btn-min-width mr-1 mb-1" data-toggle="modal"
										data-target="#add_shed"><i class="la la-plus">&nbsp;Add Rec</i></button></div>
								...
								<div class="row" id="bank" style="display: none;">
									...
									<div class="col-md-4">
										...
										<input type="text" step="any" min="0" class="form-control cheque" value="{{old('cheque')}}" name="cheque" id="cheque" placeholder="">
