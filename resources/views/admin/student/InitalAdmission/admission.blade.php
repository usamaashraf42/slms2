                ...
                <div id="AdmissionInfoForm" class="row" >
                  <div class="col-md-5 col-sm-4">
                    <label class="control-label" style="width: 100%;">Name 
                      <span style="color: red">*</span></label>
                      <input class="form-control " name="s_name" value="@isset($data->name) {{ $data->name}} @endisset"  id="s_name" type="text" placeholder="Enter the student Name">
                      ...
                      <div class="ui calendar" id="dateofbirth" style="width: 100%;">
                        <div class="ui input" style="width: -webkit-fill-available!important;">
                          <input class="form-control ip-android-1" readonly  name="s_DOB" id="s_DOB" value="@isset($data->dob) {{$data->dob}} @endisset" type="text">
                      ...
                      <input class="form-control" value="@isset($data->father_name) {{$data->father_name}} @endisset" name="s_fatherName" id="s_fatherName" type="text" placeholder="Enter The Father Name" class="input-xlarge">
                              ...
                              <table class="table table-bordered">
                                ...
                                <tbody id="qualificationRows">
                                  <tr>
                                    ...
                                    <td><input class="form-control fatherphonefirst phone_no" value="@isset($data->contact_no) {{$data->contact_no}} @endisset" name="parent_phone[]" id="parent_phone[]" type="number" placeholder="Enter the Mobile No :" > <p class="alert alert-danger phone_no_eror" style="display: none"></p></td>


                                    <td><input class="form-control home_address" value="@isset($data->address) {{$data->address}} @endisset" name="parent_address[]" id="home_address" type="text" placeholder="Enter the Address :" >
                                      <p class="alert alert-danger home_address_eror" style="display: none"></p>
                                    </td>

                                    <td> <input  class="form-control email_address" value="@isset($data->email) {{$data->email}} @endisset" name="parent_email[]" id="parent_email[]" type="email" placeholder="Enter the Email :" >
...
function countryHasBranch(obj){
  ...
  @endif
  @if($data->branch_id)
  var branch_id1=<?php  echo $data->branch_id ?>;
  @else
