	...
	<div class="row">
      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-sm-8">
              <h4 class="page-title">Branch Mangement</h4>
            </div>
            <div class="col-sm-4 text-right m-b-30">
              <a href="{{route('branch.create')}}" class="btn btn-primary rounded" ><i class="fa fa-plus"></i> Add New </a>
            </div>
          </div>
          <br>
...
<script>
  ...
  $('#category_table').DataTable( {
    ...
    {"data":"branch_name"},
    {"data":"mangerName","render":function(status,type,row){
      console.log(row);
      return row.mangerName?row.mangerName:'';

    }},
    {"data":"b_emil","render":function(status,type,row){
      console.log(row);
      return row.b_emil?row.b_emil:'';
