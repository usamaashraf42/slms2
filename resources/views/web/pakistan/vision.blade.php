...
<section class="default-main content-start relative bg-white">
        ...
        <div class="flex flex-row-ns flex-column flex-wrap mw8 center relative">
            <div class="main-section w-70-l w-70-m w-100 ph4 ph0-l">
                <div class="w-100">
                    <h1 class="mt5-ns pr4-ns hidden-element fade-down element-load">Vision of American Lyceum</h1>
                </div>
                ...
                <div class="templatecontent ">
                    <p class="lead"><em>Our Vision...
                    	<br>
                            “By Cultivating The Crop Of Enlightened Leader Become the name of Trust, Pride, Performance and Excellence.
                            ”
                        </em>
                    </p>
                    <center>&nbsp;</center>
