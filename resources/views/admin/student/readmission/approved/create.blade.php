...
@section('title', 'Approval Student Re-admission')
@section('content')
		...
		<div class="col-md-12 col-sm-12 col-lg-12 col-xl-12">
			<div class="card-box">
				<div class="card-block">
					<h4 class="card-title">Approval Student Re-admission</h4>
					
					@component('_components.alerts-default')
					@endcomponent
					<form method="POST" action="{{ route('approveBranchWiseLeft') }}" enctype = "multipart/form-data" id="upload_new_form">
								<div class="col-md-12">
									{{csrf_field()}}
