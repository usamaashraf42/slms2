    ...
    <section class="default-main content-start relative bg-white">
        {{--<h4>Please fill out the New application of American lyceum Admission </h4>--}}
            <div class="container" style="align-content: center;text-align: center">
            	...
            	<h4>Summer Camp Registration</h4></p>
        	</div>
            <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="branch_id" id="branch_id" required>
                                ...
                                @php($oman=\App\Models\Branch::where('b_countryCode',968)->where('isFranchise',1)->get())
                                @foreach($oman as $om)
         ...
         {{--righ side space--}}
            <div class="col-md-6">
                 <img src="{{asset('images/web/SummerCampBrochureMuscat.png')}}">
   </section>
</div>
</div>
</div>
