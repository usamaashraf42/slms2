        ...
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-sm-4 text-right m-b-30">
              <a href="{{route('exam-category.create')}}" class="btn btn-primary rounded" ><i class="fa fa-plus"></i> Add New </a>
            </div>
          </div>
          <br>
...
<script>
  ...
  $('#category_table').DataTable( {
    ...
    {"data":"parent_id","render":function(status,type,row){
      console.log('parent_id',row);
      return row.parent?row.parent.term:'';

    }},
    {"data":"term","render":function(status,type,row){
      return row.term?row.term:'';

    }},
    {"data":"from_date","render":function(status,type,row){
      return row.from_date?row.from_date:'';

    }},
    {"data":"to_date","render":function(status,type,row){
    ...
    {"data":"id","render":function(id){
      var edit_route = '{{ route("exam-category.edit", ":id") }}';
