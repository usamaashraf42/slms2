	...
	<div class="row">
      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-sm-8">
              <h4 class="page-title">Account Category</h4>
            </div>
            <div class="col-sm-4 text-right m-b-30">
              <a href="{{route('account-category.create')}}" class="btn btn-primary rounded" ><i class="fa fa-plus"></i> Add New </a>
            </div>
          </div>
          <br>
...
<script>
  ...
  $('#category_table').DataTable( {
    ...
    ajax: {
      ...
      "url":"<?= route('get_account_category') ?>",
      "dataType":"json",
      "type":"POST"
    },
    columns:[
...
{"data":"id"},
    ...
    {"data":"id","render":function(id){
      var edit_route = '{{ route("account-category.edit", ":id") }}';
      edit_route = edit_route.replace(':id', id);

      // var delete_route = '{{ route("account-category.edit", ":id") }}';
