                            ...
                            <div class="wizard-steps">
                                <div class="wizard-step" data-wizard-type="step" data-wizard-state="current">
                                    <div class="wizard-wrapper">
                                        ...
                                        <div class="wizard-label">
                                            <h3 class="wizard-title">Bio Information</h3>
                                            <div class="wizard-desc">Setup Your Bio Information</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="wizard-step" data-wizard-type="step" data-wizard-state="pending">
                                    <div class="wizard-wrapper">
                                        ...
                                        <div class="wizard-label">
                                            ...
                                            <div class="wizard-desc">Add Your Experience</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="wizard-step" data-wizard-type="step" data-wizard-state="pending">
                                    <div class="wizard-wrapper">
                                        ...
                                        <div class="wizard-label">
                                            <h3 class="wizard-title">Demo Video</h3>
                                            <div class="wizard-desc">Record a demo Video</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="wizard-step" data-wizard-type="step" data-wizard-state="pending">
                                    <div class="wizard-wrapper">
                                        ...
                                        <a href="{{route('jobApplicant.record_video')}}">
                                        <div class="wizard-label">
                                            <h3 class="wizard-title">Upload Your Sample Video</h3>
                                            <div class="wizard-desc">Record</div>
                                        </div>
                                        </a>
                                    </div>
                                </div>
...
@endsection
@push('post-styles')
<link href="{{ asset('job_assets/css/pages/wizard/wizard-2d1cf.css?v=7.1.6')}}" rel="stylesheet" type="text/css" />

@endpush

@push('post-scripts')
{{-- <script src="{{ asset('job_assets/js/pages/custom/wizard/wizard-2d1cf.js?v=7.1.6')}}"></script> --}}
<script>
    "use strict";
