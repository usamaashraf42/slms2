		...
		<div class="col-md-12 col-sm-12 col-lg-12 col-xl-12">
			<div class="card-box">
				<div class="card-block">
					<h4 class="card-title">Marks Post</h4>
					@component('_components.alerts-default')
					@endcomponent
					<form method="POST" action="{{route('post.store')}}" enctype = "multipart/form-data" id="upload_new_form">
						<div class="col-md-12">
							{{csrf_field()}}
							<div class="row">
								<div class="col-md-3">
							...
							<div class="row">
								...
								<a class="btn btn-primary ks-rounded" onclick="addRowStudent(this)" href="javascript:;"> Add Student</a>
							</div>
						</div>
					</div>
						...
						<div class="card nextRecordGet" style="width:100%; display: block" >
							<div class="card-block">
								<div class="ks-items-block float-center" style="align-items: center;margin-left: 40%">
									<a class="btn btn-primary ks-rounded" onclick="tableShow(this)" href="javascript:;"> Load Date </a>
								</div>
							</div>
						</div>
	...
	function printDiv(eve,obj)
	{
		...
		<script type="text/javascript">
			function validate(){
				...
				if (valid && $('#class_id').val() == '') {
					$('.class_id_eror').text('Class field is required');
					$('.class_id_eror').css('display','block');
					valid = false;
				}
				if (valid && $('#section_id').val() == '') {
					$('.section_id_eror').text('Section field is required');
					$('.section_id_eror').css('display','block');
					valid = false;
				}
				if (valid && $('#subject_id').val() == '') {
					$('.s_fatherName').text('Father name field is required');
					$('.s_fatherName').css('display','block');
					valid = false;
				}
				if (valid && $('.exam_type_id').val() == '') {
					$('.exam_type_id_eror').text('Exam field is required');
					$('.exam_type_id_eror').css('display','block');
					valid = false;
				}
