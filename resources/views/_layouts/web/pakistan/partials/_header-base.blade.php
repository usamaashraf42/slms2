        ...
        <li class="sw-menucode-item" id="mn-admissions">
          ...
          <ul class="sw-menucode-list">
            ...
            <li class="sw-menucode-list__item" id="mn-how-to-apply">
              ...
              <li class="sw-menucode-list__item" id="mn-leadership">
              <a href="{{route('pakistan.Examination')}}"  class=" sw-menucode-item__link"></a>
            </li>

        <li class="sw-menucode-item" id="mn-career">
          <a href="javascript:;" class=" sw-menucode-item__link">Career</a>
          <ul class="sw-menucode-list">
            <li class="sw-menucode-list__item" id="mn-core-values">
              <a href="{{route('pakistan.Jobs_now')}}" class="first  sw-menucode-item__link">Jobs</a>
            </li>
            <li class="sw-menucode-list__item" id="mn-core-values">
              <a href="{{route('pakistan_job_internship')}}" class="first  sw-menucode-item__link">Internship</a>
            </li>
