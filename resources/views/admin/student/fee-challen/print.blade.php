									...
									<div class="table_under_div">
										...
										<div  style="max-height: 40%;">
											<div style=" float: right; margin-top: 2px;border: 1px solid;font-size: 13px; width: 37.50%;">
												<div >Annual Fee:  @if(isset($data->studentFee['annual_fee'])){{$data->studentFee['annual_fee']}}@else {{0}}  @endif : Total Installment :@if(isset($data->studentFee['installment_no'])){{$data->studentFee['installment_no']}}@else {{0}}@endif </div>
											...
											<table border="" style="font-size: 13px; border-collapse: collapse!important; width: 38%; float: right;">
												...
												<tr>
													...
													<td><i style="margin-left: 2px">@isset($feeArray[0]['admissionFee']){{$feeArray[0]['admissionFee']}}@endisset</i>/<i style="margin-left: 10px">@if(isset($feeArray[0]['registerationFee'])){{$feeArray[0]['registerationFee']}}@else{{0}}@endif</i></td>
												</tr>
												...
												<tr>
													<td>
														...
														<td>
															...
															<i style="margin-left: 2px">@if(isset($feeArray[0]['sec_fee'])){{$feeArray[0]['sec_fee']}}@else{{0}}@endif</i>/
															@endif
															@if(isset($record->userSetting->deffered) && ($record->userSetting->deffered))
															<i style="margin-left: 10px">@if(isset($feeArray[0]['deffered_amount'])){{$feeArray[0]['deffered_amount']}}@else{{0}}@endif</i>@endif
														</td>
													...
													<tr>
														<td>
															...
															<td><i style="margin-left: 2px">@isset($feeArray[0]['examfee']){{$feeArray[0]['examfee']}}@endisset</i><i style="margin-left: 5px"></i></td>
														...
														<tr>
															...
															<td>
																...
																<i style="margin-left: 2px">@isset($feeArray[0]['comp_fee']){{$feeArray[0]['comp_fee']}}@endisset</i>/ 
																@endif 
																@if(isset($record->userSetting->utitlity) && $record->userSetting->compFee)
																<i style="margin-left: 5px">@isset($feeArray[0]['utility_fee']){{$feeArray[0]['utility_fee']}}@endisset</i> 
																@endif
															</td>
														</tr>
														@endif
														...
														<tr>
															...
															<td>
																@if($record->userSetting->StatFee) 
																<i style="margin-left: 2px">@isset($feeArray[0]['statfee']){{$feeArray[0]['statfee']}}@endisset</i>/
																@endif
																@if($record->userSetting->labFee)
																<i style="margin-left: 2px">@isset($feeArray[0]['statfee']){{$feeArray[0]['labfee']}}@endisset</i>
																@endif
															</td>
														</tr>
														@endif
														...
														<tr>
															...
															<td>
																@if($record->userSetting->transportCharge) 
																<i style="margin-left: 2px">@isset($feeArray[0]['transport_fee']){{$feeArray[0]['transport_fee']}}@endisset</i>/
																@endif
																@if($record->userSetting->acCharge) 
																<i style="margin-left: 2px">@isset($feeArray[0]['accharge']){{$feeArray[0]['accharge']}}@endisset</i>
																@endif
															</td>
														</tr>
														@endif
														...
														<!-- <tr>
															...
															<td>
																@if($record->userSetting->summerPack)
																<i style="margin-left: 2px">@isset($feeArray[0]['libfee']){{$feeArray[0]['libfee']}}@endisset</i>/
																@endif
																@if($record->userSetting->Insurace)
														...
														<tr>
															...
															<td>
																@if($record->userSetting->bookFee)
																<i style="margin-left: 2px">@isset($feeArray[0]['books_charges']){{$feeArray[0]['books_charges']}}@endisset</i>/
																@endif
																@if($record->userSetting->uniFee)
																<i style="margin-left: 2px">@isset($feeArray[0]['uniform']){{$feeArray[0]['uniform']}}@endisset</i>
																@endif
															</td>
														</tr>
														@endif
														...
														<tr>
															...
															<td><i style="margin-left: 2px">@isset($feeArray[0]['misc1']){{$feeArray[0]['misc1']}}@endisset</i>/<i style="margin-left: 2px">@isset($feeArray[0]['misc2']){{$feeArray[0]['misc2']}}@endisset</i></td>
														</tr>
														...
														<tr>
															...
															{{--{{dd($feeArray[0][$feeMonth'])}}--}}
														</tr>

														<tr>
															<td><i style="margin-left: 10px">Last Month Late deposit Fine</i><i style="margin-left: 2px"></i></td>
															<td><i style="margin-left: 2px">@isset($feeArray[0]['fine']){{$feeArray[0]['fine']}}@endisset</i><i style="margin-left: 2px"></i></td>
														</tr>
														...
														<tr>
															...
															<td><i style="margin-left: 2px"></i>@isset($feeArray[0]->outstand_lastmonth){{$feeArray[0]->outstand_lastmonth}}@endisset<i style="margin-left: 2px"></i></td>
														</tr>
														...
														<tr>
															...
															<td><i style="margin-left: 2px"></i> @if(isset($feeArray[0]['deffered_amount'])){{$feeArray[0]['deffered_amount']}}@else{{0}}@endif<i style="margin-left: 5px"></i></td>
														</tr>
														@endif
														...
														<tr>
															...
															<td><i style="margin-left: 2px"><b>@isset($feeArray[0]['total_fee']){{$feeArray[0]['total_fee']}}@endisset</b></i><i style="margin-left: 2px"></i></td>
														</tr>
										...
										<div class="school" style="margin-bottom:50px;margin-top: 15px;">
											...
											<table border="1px" style="font-size: 14px;padding: 1px  2px;width: 100%;border-spacing:unset!important;     border-collapse: collapse!important;" >
												...
												<tr>
													<td>@isset($feeArray[0]['transport_fee']){{$feeArray[0]['transport_fee']}}@endisset</td>
													<td>@isset($feeArray[0]['misc1']){{$feeArray[0]['misc1']}}@endisset</td>
													<td>@isset($feeArray[0]['misc2']){{$feeArray[0]['misc2']}}@endisset</td>
													<td>@isset($feeArray[0]['month_def']){{$feeArray[0]['month_def']}}@endisset/@isset($feeArray[0]['month_def']){{$feeArray[0]['total_fee']-$feeArray[0]['paid_amount']}}@endisset</td>
											...
											<div class="school" style="margin-bottom:50px;">
												...
												<table border="1px" style="font-size: 14px;padding: 1px  2px;width: 100%;border-spacing:unset!important;     border-collapse: collapse!important;" >
													...
													<tr>
														...
														<td>@isset($feeArray[0]['misc2']){{$feeArray[0]['misc2']}}@endisset</td>
														<td>@isset($feeArray[0]['month_def']){{$feeArray[0]['month_def']}}@endisset/@isset($feeArray[0]['month_def']){{$feeArray[0]['total_fee']-$feeArray[0]['paid_amount']}}@endisset</td>
														<td>@isset($feeArray[0]->outstand_lastmonth){{$feeArray[0]->outstand_lastmonth}}@endisset</td><td>@isset($feeArray[0]['accharge']){{$feeArray[0]['accharge']}}@endisset</td></tr>
													</table>
													<div class="calculation" style="float: right;border: 1px solid">
														<table border="1px solid" style="font-size: 14px;padding: 1px  2px;border-spacing:unset!important;     border-collapse: collapse!important;">
															<tr>
