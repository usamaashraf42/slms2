    ...
    <div class="sidebar-inner slimscroll">
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                <li class="submenu ">
                    <a href="javascript:;" class="{{ areActiveRoutes(['subject.index','subject.create','subject.edit','section.index','section.create','section.edit','class.index','class.create','class.edit'])}}"><i class="fa fa-user" aria-hidden="true"></i> <span> Academic Management</span> <span class="menu-arrow"></span></a>
            ...
            <li class="submenu ">
                ...
                <ul class="list-unstyled" style="display: none;">
                    ...
                    <li class="{{ areActiveRoutes(['branch-class-student.index','branch-class-student.create','branch-class-student.edit'])}}">
                        <a href="{{route('branch-class-student.index')}}" class="{{ areActiveRoutes(['branch-class-student.index','branch-class-student.create','branch-class-student.edit'])}}"><i class="fa fa-user" aria-hidden="true"></i> 
                            <span> Branch Class students</span> 
                        </a>
                    </li>
            ...
            <li class="submenu ">
                ...
                <ul class="list-unstyled" style="display: none;">
                    ...
                    <li class="{{ areActiveRoutes(['new-application.index','new-application.create','new-application.edit'])}}">
                        <a href="{{route('new-application.index')}}" class="{{ areActiveRoutes(['new-application.index','new-application.create','new-application.edit'])}}"><i class="fa fa-user" aria-hidden="true"></i> 
                            <span>New Application</span> 
                        </a>
                    </li>


                    <li class="{{ areActiveRoutes(['short-list.index','short-list.create','short-list.edit'])}}">
                        <a href="{{route('short-list.index')}}" class="{{ areActiveRoutes(['short-list.index','short-list.create','short-list.edit'])}}"><i class="fa fa-user" aria-hidden="true"></i> 
                    ...
                    @endif
                    <li class="submenu">
                       <a href="javascript:;"><i class="fa fa-user" aria-hidden="true"></i>  <span> evaluation  </span>  <span class="menu-arrow"></span></a>
                       <ul style="display: none;">
                         <li><a href="{{route('performance-indicator.index')}}"> evaluation Indicator  </a></li>
                         <li><a href="{{route('performance.index')}}"> evaluation Review  </a></li>
                     </ul>
                 </li>
                ...
                <li class="submenu ">
                    <a href="#" class="{{ areActiveRoutes(['department.create','department.store','department.index','designation.create','designation.store','designation.index','department-shift.create','department-shift.store','department-shift.index'])}}"><i class="fa fa-user" aria-hidden="true"></i> <span> Departmentalization </span> <span class="menu-arrow"></span></a>
                    <ul class="list-unstyled" style="display: none;">
                        ...
                        <li class="{{ areActiveRoutes(['department-shift.index','department-shift.create','department-shift.edit'])}}"><a href="{{route('department-shift.index')}}"> Shift</a></li>
                ...
                <li class="submenu">
                    ...
                    <ul style="display: none;">  
                        <li><a href="{{route('employee-statement.index')}}">Employee Statement</a></li>                   
                ...
                <li class="submenu">
                    <a href="javascript:;"><i class="la la-money"></i>  <span> Payroll  </span>  <span class="menu-arrow"></span></a>
                    <ul style="display: none;">
                        ...
                        <li><a href="{{route('pay-slip.index')}}"> Salary List  </a></li>
        ...
        <li class="submenu ">
            ...
            <li class="submenu">
                <a href="#" class="{{ areActiveRoutes(['attendance.index.index','attendance.index.edit','attendance.create'])}}"><i class="fa fa-user" aria-hidden="true"></i> <span> Attendance</span> <span class="menu-arrow"></span></a>
                <ul class="list-unstyled" style="display: none;">
                ...
                <ul class="list-unstyled" style="display: none;">
                    ...
                    <li class="submenu">
                        ...
                        <ul class="list-unstyled" style="display: none;">
                           ...
                           <li class="{{ areActiveRoutes(['manual-fee-deposit.create','manual-fee-deposit.index'])}}"><a href="{{route('manual-fee-deposit.index')}}">Manual Fee Deposit</a></li>
...
<li class="submenu ">
    <a href="javascript:;" class="{{ areActiveRoutes(['product-category.index','product-category.create','product-category.edit','product-sub-category.index','product-sub-category.create','product-sub-category.edit','product.index','product.create','product.edit','inventory.index','inventory.create','inventory.edit'])}}"><i class="fa fa-user" aria-hidden="true"></i> <span> Inventory Management </span> <span class="menu-arrow"></span></a>
    <ul class="list-unstyled" style="display: none;">
        ...
        <li class="{{ areActiveRoutes(['inventory.index','inventory.create','inventory.edit'])}}">
            <a href="{{route('inventory.index')}}" class="{{ areActiveRoutes(['inventory.index','inventory.create','inventory.edit'])}}"><i class="fa fa-user" aria-hidden="true"></i> 
                <span> Inventory</span> 
            </a>
        </li>
