		...
		<div class="col-md-12 col-sm-12 col-lg-12 col-xl-12">
			<div class="card-box">
				<div class="card-block">
					...
					@endcomponent
					<form method="POST" action="{{ route('designation.store') }}" enctype = "multipart/form-data" id="upload_new_form">
						{{ csrf_field() }}
							...
							<div class="col-md-9" style="margin-bottom: 20px;">
									...
									<div class="row" style="margin: 10px 0px;">
										<div class="col-md-12">
											...
											<input name="designation" value="{{ old('designation') }}" type="text" placeholder="Designation Name" class="form-control">
