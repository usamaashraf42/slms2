...
@section('title', 'Approved Student Left')
@section('content')
<style>
  .table td, .table th {
		...
		<div class="col-md-12 col-sm-12 col-lg-12 col-xl-12">
			<div class="card-box">
				...
				<div class="card-block">
					<h4 class="card-title">Approved Student Left </h4>
...
<script>
	...
	function null_model(){
      ...
      function unapproveRequest(id){
         ...
         $.ajax({
            url: "admin/student/left-student" + '/' + id + '/edit', 
            method:"GET",
         ...
         $.ajax({
            url: "{{route('approval-left-student.store')}}", 
            method:"POST",
            data:{left_id:correction_id,remarks:remarks},
            success: function(response){
