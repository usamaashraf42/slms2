		...
		<div class="col-md-12 col-sm-12 col-lg-12 col-xl-12">
			<div class="card-box">
				<div class="card-block">
					...
					@endcomponent
					<form method="POST" action="{{ route('department.update',$department->id) }}" enctype = "multipart/form-data" id="upload_new_form">
						{{ csrf_field() }}
						@method('PUT')
							...
							<div class="col-md-12" style="margin-bottom: 20px;">
								...
								<div class="row" style="margin: 10px 0px;">
									<div class="col-md-4">
										...
										<input name="dep_name" value="{{ $department->dep_name }}" type="text" placeholder="Department Name" class="form-control">
									...
									<div class="col-md-2">
										...
										<input name="start_time" value="{{ $department->start_time }}" type="text" placeholder="8:00" class="form-control start_time">
									...
									<div class="col-md-2">
										...
										<input name="relaxation_start_time" value="{{ $department->relaxation_start_time }}" type="text" placeholder="8:30" class="form-control relaxation_start_time">
									...
									<div class="col-md-2">
										...
										<input name="end_time" value="{{ $department->end_time }}" type="text" placeholder="2:00"  class="form-control end_time">
									...
									<div class="col-md-2">
										...
										<input name="relaxation_end_time" value="{{ $department->relaxation_end_time }}" type="text" placeholder="2:30"  class="form-control relaxation_end_time">
								...
								<div class="row" style="margin: 10px 0px;">
									...
									<div class="col-md-3">
										...
										<input name="e_off_fine" value="{{ $department->e_off_fine }}" type="number" step="any" placeholder="0" class="form-control">
									...
									<div class="col-md-3">
										...
										<input name="late_fine" value="{{ $department->late_fine }}" type="number" step="any" placeholder="0" class="form-control">
									...
									<div class="col-md-3">
										...
										<input name="leave_fine" value="{{ $department->leave_fine }}" type="number" step="any" placeholder="0" class="form-control">
									...
									<div class="col-md-3">
										<label class="control-label">Absent fine / day (%)</label>
										<input name="absent_fine" value="{{ $department->absent_fine }}" type="number" step="any" placeholder="0" class="form-control">
										@if ($errors->has('absent_fine'))
										<div class="alert alert-danger" role="alert">
											<button type="button" class="close" data-dismiss="alert" aria-label="Close">
												<span aria-hidden="true">×</span>
												<span class="sr-only">Close</span>
											</button>
											<strong>Warning!</strong> {{$errors->first('absent_fine')}}
										</div>
										@endif
									</div>
								</div>
								<div class="row" style="margin: 10px 0px;">
									<div class="col-md-12 col-sm-12">
										...
										<select id='permission-selected-options' multiple='multiple' name="branch_ids[]">
											...
											<option value="{{$branch['id']}}" @if($department->hasBranch($branch['id'])) selected @endif>{{$branch['branch_name']}}</option>
											@endforeach
											@endif
