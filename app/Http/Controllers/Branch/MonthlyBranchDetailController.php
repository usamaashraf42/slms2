...
use Auth;
class MonthlyBranchDetailController extends Controller
{
   ...
   public function index(){
    ...
    $records=$branch->get();
    return view('admin.branch.monthly.full',compact('records'));
}
...
$branches=$branch->get();
$classes=Course::get();
return view('admin.branch.monthly.create',compact('branches','classes'));
}
...
return view('admin.branch.monthly.index',compact('branch','month','year'));
}
}
