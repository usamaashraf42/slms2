          ...
          <div class="tab-content">
            <div class="tab-pane active" id="home-v" style="background-color: #fff!important;">  
             ...
             <div class="col-md-4">
               ...
               <input class="form-control annual_fee" readonly  type="number" step="any" id="annual_fee" min="0" value="0" name="annual_fee" placeholder="Enter the Annual Fee :" class="input-xlarge">
           ...
           <div class="col-md-4">
             ...
             <input class="form-control"type="number" readonly step="any" value="0" min="0" name="monthly_fee" id="monthly_fee" placeholder="Monthly Fee:" class="input-xlarge"   >
           </div>
           <div class="col-md-4">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-4">
            ...
            <div class="col-sm-4">
              <div class="ui calendar" id="example1" style="width: 100%">
                <div class="ui input" style="width: -webkit-fill-available!important;">
                  <input type="text" class="form-control fee_due_date2" value="{{old('fee_due_date2')}}" name="fee_due_date2" id="fee_due_date2" autocomplete="off"  placeholder="Red Due Date ">
                </div>
              </div>
          ...
          <div class="form-group row">
            ...
            <!-- <div class="col-sm-2">
              <div class="checkbox">
                @if(date('d') < 21)
                <input type="checkbox" class="checkbox_1" @if(date('d') < 21) disabled='true' @endif name="feePostMonth" value="1" checked >
                <input type="hidden" class="" name="feePostMonth" value="1" >
                @else
                <input type="checkbox" class="checkbox_1"  name="feePostMonth" value="1" checked >
                @endif
            ...
            <div class="col-sm-2">
               <!-- <div class="checkbox">
                <input type="checkbox" class="checkbox_1" name="freeze" value="1">  <label> Freeze  </label>
              </div> -->
            </div>
            ...
            <!-- <div class="col-md-12 dropDownInstallment" style="display: none">
              ...
              <select class="form-control" type="number" onchange="MonthWisestructure(this)" value="1" step="any" id="fee_factor" min="1" max="12" name="installment_no"         placeholder="Enter the Total Fee Factor :" class="input-xlarge">
                ...
                <option value="0">Charge Fee from ( {{ date('Y')}} )  {{ getMonthName(((int)date('m'))+1) }}  </option>
                    ...
                    <div class="col-md-12 annulystructure" style="display: block">
                      <label class="control-label">Configure Installment:</label>
                      <select class="form-control installment_no" type="number" onchange="MonthWisestructure(this)" value="1" step="any" id="fee_factor" min="1" max="12" name="installment_no"         placeholder="Enter the Total Fee Factor :" class="input-xlarge">
                        <option disabled="disabled" selected="selected" value="0">Choose the Installment</option>
                        <option value="1" class="fee_factor1" >1</option>
                        <option value="2" class="fee_factor2" >2</option>
                        <option value="3" class="fee_factor3" >3</option>
                        <option value="4" class="fee_factor4" >4</option>
                        <option value="5" class="fee_factor4" >5</option>
                        <option value="6" class="fee_factor6" >6</option>

                        <option value="7" class="fee_factor7" >7</option>
                        <option value="8" class="fee_factor8" >8</option>
                        <option value="9" class="fee_factor9" >9</option>

                        <option value="10" class="fee_factor10" >10 </option>
                        <option value="12" class="fee_factor12" >12</option>
                        <option value="15" class="fee_factor15" >Other</option>
                      </select>
                      <p class="alert alert-danger installment_no_erorr" style="display: none"></p>
                    </div>
                    <div class="col-md-12 MonthWisestructure" style="display: none">
                      <label class="control-label">Configure Installment Month Wise:</label>
                      <div class="row">
                        <div class="col-md-4">
                         <label class="control-label">January:</label>
                         <input class="form-control cutomFeeFactor annualFee m1" type="number"  min="0" step="any" value="0" id="m1" name="m1" placeholder="Enter the January Factor :" class="input-xlarge">
                       </div>
                       <div class="col-md-4">
                         <label class="control-label">February:</label>
                         <input class="form-control cutomFeeFactor annualFee m2" type="number"  min="0" step="any" value="0" id="m2" name="m2" placeholder="Enter the February Factor :" class="input-xlarge">
                       </div>
                       <div class="col-md-4">
                         <label class="control-label">March:</label>
                         <input class="form-control cutomFeeFactor annualFee m3" type="number"  step="any" min="0" value="0" id="m3" name="m3" placeholder="Enter the March Factor :" class="input-xlarge">
                       </div>
                       <div class="col-md-4">
                         <label class="control-label">April:</label>
                         <input class="form-control cutomFeeFactor annualFee m4" type="number"  min="0" step="any" value="0" id="m4" name="m4" placeholder="Enter the April Factor :" class="input-xlarge">
                       </div>
                       <div class="col-md-4">
                         <label class="control-label">May:</label>
                         <input class="form-control cutomFeeFactor annualFee m5" type="number"  min="0" step="any" value="0" id="m5" name="m5" placeholder="Enter the May Factor :" class="input-xlarge">
                       </div>
                       <div class="col-md-4">
                         <label class="control-label">June:</label>
                         <input class="form-control cutomFeeFactor annualFee m6" type="number"  min="0" step="any" value="0" id="m6" name="m6" placeholder="Enter the June Factor :" class="input-xlarge">
                       </div>
                       <div class="col-md-4">
                         <label class="control-label">July :</label>
                         <input class="form-control cutomFeeFactor annualFee m7" type="number"  min="0" step="any" value="0" id="m7" name="m7" placeholder="Enter the July Factor :" class="input-xlarge">
                       </div>
                       <div class="col-md-4">
                         <label class="control-label">August:</label>
                         <input class="form-control cutomFeeFactor annualFee m8" type="number"  step="any" value="0" id="m8" name="m8" placeholder="Enter the August Factor :" class="input-xlarge">
                       </div>
                       <div class="col-md-4">
                         <label class="control-label">September:</label>
                         <input class="form-control cutomFeeFactor annualFee m9" type="number"  min="0" step="any" value="0" id="m9" name="m9" placeholder="Enter the September Factor :" class="input-xlarge">
                       </div>
                       <div class="col-md-4">
                         <label class="control-label">October:</label>
                         <input class="form-control cutomFeeFactor annualFee m10" type="number"  min="0" step="any" value="0" id="m10" name="m10" placeholder="Enter the October Factor :" class="input-xlarge">
                       </div>
                       <div class="col-md-4">
                         <label class="control-label">November:</label>
                         <input class="form-control cutomFeeFactor annualFee m11" type="number"  min="0" step="any" value="0" id="m11" name="m11" placeholder="Enter the November Factor :" class="input-xlarge">
                       </div>
                       <div class="col-md-4">
                         <label class="control-label">December:</label>
                         <input class="form-control cutomFeeFactor annualFee m12" type="number"  min="0" step="any" value="0" id="m12" name="m12" placeholder="Enter the December Factor :" class="input-xlarge">
                       </div>
...
<!-- <link href="https://cdn.rawgit.com/mdehoog/Semantic-UI/6e6d051d47b598ebab05857545f242caf2b4b48c/dist/semantic.min.css" rel="stylesheet" type="text/css" />
  ...
  <!-- <link rel="stylesheet" href="{{asset('js/datepickerScroll/external/jquery.mobile-1.3.0.min.css')}}" /> -->
<!--   <link href="{{asset('js/datepickerScroll/css/mobipick.css')}}" rel="stylesheet" type="text/css" />
  <link href="{{asset('js/datepickerScroll/demo/shCoreDefault.css')}}" rel="stylesheet" type="text/css" />
  <link href="{{asset('js/datepickerScroll/demo/shThemeDefault.css')}}" rel="stylesheet" type="text/css" /> 
  <script type="text/javascript" src="{{asset('js/datepickerScroll/demo/shCore.js')}}"></script>
  <script type="text/javascript" src="{{asset('js/datepickerScroll/demo/shBrushJScript.js')}}"></script>
  <script type="text/javascript" src="{{asset('js/datepickerScroll/demo/shBrushXml.js')}}"></script>
  <script type="text/javascript" src="{{asset('js/datepickerScroll/external/modernizr.custom.min.js')}}"></script>
  <script type="text/javascript" src="{{asset('js/datepickerScroll/external/xdate.js')}}"></script>
  <script type="text/javascript" src="{{asset('js/datepickerScroll/external/xdate.i18n.js')}}"></script>
  <script type="text/javascript" src="{{asset('js/datepickerScroll/external/jquery-1.9.1.min.js')}}"></script>
  <script type="text/javascript" src="{{asset('js/datepickerScroll/external/jquery.mobile-1.3.0.min.js')}}"></script>
  <script type="text/javascript" src="{{asset('js/datepickerScroll/js/mobipick.js')}}"></script> -->
  <script>
  // $( ".mobipick-demo-default-date").mobipick();
 //  var today = new Date();
 //  $('#example12').calendar({
 //    monthFirst: false,
 //    type: 'date',
...
<script>
  ...
  function disableOptionSession(){
    console.log('disableOptionSession');
    // $( ".fee_factor1" ).prop( "disabled", true );
    // $( ".fee_factor2" ).prop( "disabled", true );
    // $( ".fee_factor3" ).prop( "disabled", true );
    // $( ".fee_factor4" ).prop( "disabled", true );
    // $( ".fee_factor5" ).prop( "disabled", true );
    // $( ".fee_factor6" ).prop( "disabled", true );
    // $( ".fee_factor7" ).prop( "disabled", true );
    // $( ".fee_factor8" ).prop( "disabled", true );
    // $( ".fee_factor9" ).prop( "disabled", true );
    // $( ".fee_factor10" ).prop( "disabled", true );
    // $( ".fee_factor11" ).prop( "disabled", true );
    // $( ".fee_factor12" ).prop( "disabled", true );

    // $('.m1').prop('readonly', true);
    // $('.m2').prop('readonly', true);
    // $('.m3').prop('readonly', true);
    // $('.m4').prop('readonly', true);
    // $('.m5').prop('readonly', true);
    // $('.m6').prop('readonly', true);
    // $('.m7').prop('readonly', true);
    // $('.m8').prop('readonly', true);
    // $('.m9').prop('readonly', true);
    // $('.m10').prop('readonly', true);
    // $('.m11').prop('readonly', true);
    // $('.m12').prop('readonly', true);
  ...
  function changeSessionPackage(ohj){
    ...
    if(session_v=='April'){
      ...
      if(curent>=4){
        ...
        console.log('totalSessionPackageApril',total);
        // if(total==10){

        //   $( ".fee_factor14" ).prop( "disabled", false );
        // }
        // for(var i=1; i<=total; i++){
        //   console.log('fee_factor disable',i);
        //   $( ".fee_factor"+i ).prop( "disabled", false );
        // }

        // for(var i=curent; i<=12; i++){
        //   console.log('after current april',i);
        //   $('.m'+i).prop('readonly', false);
        // }

        // for(var i=1; i<=3; i++){
        //   console.log('after second current april',i);
        //   $('.m'+i).prop('readonly', false);
        // }
...
function every_changeFeeSturture(obj){
  console.log('radio',$(obj).val());
  if($(obj).val() == 'monthly'){
    $('.every_cutomFee').val(0);
    var annual_total_fee=parseFloat($("#total_fee").val());
    var factorSix=parseFloat(annual_total_fee/12).toFixed(2);
    $('.every_annualFee').val(factorSix);

    $('.every_MonthWisestructure').css('display','block');
    $('.every_annulystructure').css('display','none');
    $('.dropDownInstallment').css('display','none');
    // $('.monthlystructure').css('display','none');
  }else{
    $('.every_cutomFee').val(0);
    $('.dropDownInstallment').css('display','block');
    $('.every_monthlystructure').css('display','none');
    $('.every_annulystructure').css('display','block');
  ...
  if($(obj).val() == 'custom'){
    $('.every_cutomFee').val(0);
    $('.dropDownInstallment').css('display','block')
    $('.every_monthlystructure').css('display','block');
    $('.every_annulystructure').css('display','none');
    $('.every_MonthWisestructure').css('display','block');
  }
  customFeeFactor();
...
function changeFeeSturture(obj){
  ...
  if($(obj).val()=='annual'){
    ...
    $('.pendingPayment').css('display','block');
    $('.annulystructure').css('display','block');
    $('.dropDownInstallment').css('display','none');

    var session_v=$('#session').val();
    if(session_v=='April'){
      var annual_total_fee=parseFloat($(".annually").val());
      var factorSix=parseFloat(annual_total_fee/12).toFixed(2);
      var totalPendingMonth=month-5;
      var totalPendingAmount=parseFloat(totalPendingMonth*factorSix);

    }else{
      var annual_total_fee=parseFloat($(".annually").val());
      var factorSix=parseFloat(annual_total_fee/12).toFixed(2);
      var totalPendingMonth=month-9;
      var totalPendingAmount=parseFloat(totalPendingMonth*factorSix);
    }
    console.log('totalPendingAmount',totalPendingAmount);
    $('.pendingFee').val(totalPendingAmount);
    totalpayed();
    // $('.monthlystructure').css('display','none');
  }else{
    $('.cutomFee').val(0);
    $('.pendingPayment').css('display','none');
    $('.monthlystructure').css('display','none');
    $('.annulystructure').css('display','block');
    $('.dropDownInstallment').css('display','block');
    $('.pendingFee').val(0);
...
function checkFeeStructurUpdate(factor,amount){
  var session_v=$('#session').val();
  if(session_v=='April'){
    console.log('curentApriol',month);
    if(month>=4){
      var month_b=12-month;
      var total=month_b+4;

      console.log('checkFeeStructurUpdateApril',total);


      for(var i=month; i<=12; i++){
        console.log('after current april',i);
        $('.m'+i).val('readonly', false);
      }
  ...
  if(session_v=='Sep'){
    console.log('curentSep',month);
    if(month>=8){
      var month_b=12-month;
      var total=parseInt(month_b+8);
      console.log('checkFeeStructurUpdateSep',total);
...
function nameChangeMonthWisestructure(obj){
  var session_v=$('#session').val();
  $('.MonthWisestructure').css('display','block');
  $('.annualFee').val(0);
  var annual_total_fee=parseFloat($("#total_fee").val());
...
if(factor==14){
  var feeMonth=month;
  var factorSix=parseFloat(annual_total_fee/10).toFixed(2);
  for(i=1; i<=12; i++){
    if(i==1){
      if(feeMonth==16){
        feeMonth=4;
      ...
      if(feeMonth==5 || feeMonth==8){
        var doubleFee=(factorSix).toFixed(2);
        $('.MonthWisestructure').find('.m'+feeMonth).val(0);
      }else{
        $('.MonthWisestructure').find('.m'+feeMonth).val(factorSix);
      }
...
if(factor==7){
  var feeMonth=month;
  var factorSix=parseFloat(annual_total_fee/7).toFixed(2);
...
if(factor==8){
  var feeMonth=month;
  var factorSix=parseFloat(annual_total_fee/8).toFixed(2);
  //////////////////// Factor Start

  if(session_v=='Sep'){
    console.log('factor8',factorSix);
    $('.m11').val(factorSix);
    $('.m12').val(factorSix);
    $('.m1').val(factorSix);
    $('.m2').val(factorSix);
    ...
    /////////////??????? End Factor
  // $('.MonthWisestructure').find('.m1').val(factorSix);
  // $('.MonthWisestructure').find('.m2').val(factorSix);
  // $('.MonthWisestructure').find('.m3').val(factorSix);
  // $('.MonthWisestructure').find('.m4').val(factorSix);
  // $('.MonthWisestructure').find('.m5').val(factorSix);
  // $('.MonthWisestructure').find('.m9').val(factorSix);
  // $('.MonthWisestructure').find('.m10').val(factorSix);
  // $('.MonthWisestructure').find('.m11').val(factorSix);
  // $('.MonthWisestructure').find('.m12').val(factorSix);
  // for(i=1; i<=8; i++){
  //   if(i==1){
  //     feeMonth=feeMonth+2;
  //     if(feeMonth==14){
...
if(factor==9){
  var feeMonth=month;
  var factorSix=parseFloat(annual_total_fee/9).toFixed(2);
   //////////////////// Factor Start
...
if(factor==10){
  ...
  if(session_v=='Sep'){
    console.log('curentSep',month);
        ...
        // $('.MonthWisestructure').find('.m4').val(factorSix);
        // $('.MonthWisestructure').find('.m5').val(factorSix);
        // $('.MonthWisestructure').find('.m6').val(factorSix);
        // $('.MonthWisestructure').find('.m7').val(factorSix);
        // $('.MonthWisestructure').find('.m8').val(factorSix);
...
if(factor==5){
  var feeMonth=month;
  var factorSix=parseFloat(annual_total_fee/5).toFixed(2);
  $('.m11').val(factorSix);
  $('.m12').val(factorSix);
  $('.m1').val(factorSix);
  $('.m2').val(factorSix);
...
<script type="text/javascript">
  ...
  $('.admission_Fee').add('.security_Refundable').add('.insurance_of').add('.registration_Fee').add('.transport_fee').add('.annual_fee').add('.annualFee').add('.uniform').add('.books_charges').add('#annual_scholarship_of').add('.cutomFeeFactor').add('.every_cutomFeeFactor').on('on keyup',function() {
  ...
  function totalpayed(){
    ...
    var monthFee =parseFloat($('.m'+feeMonth).val());
    ...
    var firstYearFactor=$('#fee_factor').val();
    console.log('first Year Factor',firstYearFactor);
    if(!firstYearFactor){
      console.log('inner Annualfirst Year Factor',EverymonthFee);
      if((EverymonthFee)>0){

        total_payabled+=EverymonthFee;
      }
    }else{
     console.log('inner 1st Year Factor',monthFee);
     if((monthFee)>0){
...
$(document).on("keyup", ".cutomFeeFactor", function() {
  var sum = 0;
  $(".cutomFeeFactor").each(function(){
    sum += +$(this).val();
  });
  var monthlyValue=parseFloat(sum.toFixed(2));
  $(".TotalCustomFee").val(monthlyValue);
  changeSessionPackage('obj');
});

$(document).on("keyup", ".every_cutomFeeFactor", function() {
  var sum = 0;
  $(".every_cutomFeeFactor").each(function(){
    sum += +$(this).val();
  });
  $(".TotalEveryFee").val(sum);
});

function customFeeFactor(){
  var sum = 0;
  $(".cutomFeeFactor").each(function(){
    sum += +$(this).val();
  });
...
function every_cutomFeeFactorSum(){
  var sum = 0;
  $(".every_cutomFeeFactor").each(function(){
    sum += +$(this).val();
  });
