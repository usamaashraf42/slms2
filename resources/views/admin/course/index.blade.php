				...
				<div class="card-block">
					...
					<div class="heading-elements float-right">
                        <button type="button" class="btn btn-success btn-min-width mr-1 mb-1" data-toggle="modal"
                                      data-target="#add_shed"><i class="la la-plus">&nbsp;Add Course</i></button>
                    </div>
							...
							<tbody>
								@isset($course)
									...
									<tr>
										...
										<td>@isset($cour->course_code){{$cour->course_code}}@endisset</td>
										<td>@isset($cour->course_name){{$cour->course_name}}@endisset</td>
										<td>
											@if($cour->status)
										...
										<td><a href="javascript:;" onclick="editItem({{$cour->id}})" class="btn btn-info btn-sm">Edit</a></td>
									</tr>
									@endforeach
								@endisset
							</tbody>
