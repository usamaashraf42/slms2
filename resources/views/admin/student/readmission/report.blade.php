...
@section('title', 'Student Re-admission Report')
@section('content')
	...
	<div class="row">
        ...
        <div id="printAllRecord" >
				<div class="card-block">
					<h4 class="card-title">Student Re-admission Report</h4>
             ...
             @isset($records)
              ...
              @if($classId!=$class)
                  ...
                  <tr>
                    ...
                    <td>
                      @if($pro->status==1)<button class="btn btn-success btn-sm">{{'approved'}}</button>   @endif 
                      @if($pro->status==2)<button class="btn btn-danger btn-sm">{{'Unapproved'}} </button> @endif 
                      @if($pro->status==0)<button class="btn btn-warning btn-sm">{{'pending'}} </button>   @endif 
                    </td>
