		...
		<div class="col-md-12 col-sm-12 col-lg-12 col-xl-12">
			<div class="card-box">
				<div class="card-block">
					<h4 class="card-title">School Mangement</h4>
					
					@component('_components.alerts-default')
					@endcomponent
					<form method="POST" action="{{ route('school.store') }}" enctype = "multipart/form-data" id="upload_new_form">
						{{ csrf_field() }}
							...
							<div class="col-md-9" style="margin-bottom: 20px;">
									...
									<div class="row" style="margin: 10px 0px;">
										<div class="col-md-12">
											...
											<input name="school_name" value="{{ old('school_name') }}" type="text" placeholder=" school_name" class="form-control">
									...
									<div class="row" style="margin: 10px 0px;">
										<div class="col-md-6">
											...
											<input name="school_email" type="email" value="{{ old('school_email') }}" class="form-control" placeholder="abc123@example.com">
										...
										<div class="col-md-6">
											...
											<input type="text" name="sch_cheif_name" value="{{ old('sch_cheif_name') }}" placeholder="CEO Name" class="form-control">
									...
									<div class="row" style="margin: 10px 0px;">
										<div class="col-md-6">
											...
											<input name="school_phone_no" type="text" value="{{ old('school_phone_no') }}" class="form-control" placeholder="0304587879">
										...
										<div class="col-md-6">
											...
											<input type="text" name="sch_tel_no" value="{{ old('sch_tel_no') }}" placeholder="423810131" class="form-control">
									...
									<div class="row" style="margin: 10px 0px;">
										<div class="col-md-6">
											...
											<textarea name="address" type="text" value="{{ old('address') }}" class="form-control" placeholder="address"></textarea>
