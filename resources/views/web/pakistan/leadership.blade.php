    ...
    <div class="slider" style="height: 497px;">
        ...
        <div class="swRotator swSlider " id="swSlider-296016">
            <div class="scrollable" style="height: 497px; width: 100%;">
                <div class="items" style="width: 20000em; left: -9515px;"><div class="item cloned" id="banner-element-43150" style="height: 497px; width: 1903px; float: left; background-image:  url({{asset('assets/frontend/images/student1.jpg')}});">
                        <img src="{{asset('assets/frontend/images/student1.jpg')}}" alt="" class="o-0">
                    </div>
                    ...
                    <div class="item" id="banner-element-43115" style="height: 497px; width: 1903px; float: left; background-image: url({{asset('assets/frontend/images/student1.jpg')}});">
    ...
    <div class="flex flex-row-ns flex-column flex-wrap mw8 center relative">
        <div class="main-section w-70-l w-70-m w-100 ph4 ph0-l">
            ...
            <div class="templatecontent w-100 w-70-ns pv4-ns pl4-ns pa3">
                ...
                <p>This is an exciting time for American Lyceum International School. In December 2018, American Lyceum International School got the International Award of the Best School in Dubai, UAE.  In 2018 we also got the ISO certification and got our SOPs standardized against international Standards.</p>
