             ...
             @isset($records)
              ...
              @if($classId!=$class)
                  ...
                  <tr>
                    ...
                    <td>@if($pro->status==1)<button class="btn btn-success btn-sm">{{'approved'}}</button>@endif @if($pro->status==2)<button class="btn btn-danger btn-sm">{{'Unapproved'}}@endif </button> @if($pro->status==0)<button class="btn btn-warning btn-sm">{{'pending'}}@endif </button>
                       @if($pro->status==1)<a class="btn btn-success btn-sm" href="{{route('student.certificate',$pro->id)}}">{{'Certificate'}}</a>@endif 
                    </td>
