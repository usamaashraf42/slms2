                            ...
                            <form action="" id="addDataForm" method="post" enctype="multipart/form-data">
                                ...
                                <div class="modal-body">
                                    <fieldset class="form-group floating-label-form-group">
                                        <div class="col-md-12">
                                            <label for="cat_name">Select survey Category</label>
                                            <select name="category_id" class="form-control col-md-4">
                                                <option value=" " selected>Choose category..</option>
                                                @foreach($categorys as $category)
                                                    <option value="{{$category->cat_type}}">{{$category->category_name}}</option>
                                                @endforeach
                                            </select>
                                            <div class="row">
                                                <div class="col-md-4">
            ...
            <script>
                ...
                $('.addquestion').on('click', function(e) {
                    ...
                    var increment =`  <div class="col-md-12 remove">
                                                <div class="row">
                                            <div class="col-md-4">
                                                <label for="cat_type">Option</label>
                                                <textarea type="text" class="form-control" id="question" name="options[]"></textarea>
                                            </div>
                                                    <div class="col-md-4">
                                                        <br>
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            if (response.status == '200') {
                                ...
                                swal(
                                    'Success!',
                                    'Advisary board Question added successfully',
                                    'success'
                                ).then(function(){
                                    //location.reload();
