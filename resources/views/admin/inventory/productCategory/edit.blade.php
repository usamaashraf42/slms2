        ...
        <div class="col-md-12 col-sm-12 col-lg-12 col-xl-12">
            <div class="card-box">
                <div class="card-block">
                    <h4 class="card-title">Product Category Edit</h4>
                    
                    @component('_components.alerts-default')
                    @endcomponent
                    <form method="POST" action="{{ route('product-category.update',$cat->id) }}" enctype = "multipart/form-data" id="upload_new_form">
                        {{ csrf_field() }}
                        @method('PUT')
                        <div class="row">
