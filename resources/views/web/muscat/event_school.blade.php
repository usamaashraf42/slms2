...
<div class="header-top black-bg d-none d-md-block">
      ...
      <div id="" class="ls-container ls-fullwidth" style="visibility: visible;">
         <div class="ls-inner" style="background-color: transparent; width: 100%; height: 800px;">
          <div class="ls-lt-container ls-overflow-hidden" style="width: 100%; height: 800px; display: block;">
             <div class="ls-curtiles" style="overflow: hidden;"><img src="{{asset('web/muscat/img/new_1.jpg')}}" width="100%" height="140%"></div>
...
<div class="col-sm-12 col-md-12 col-lg-12 events isotope-item">
            <div id="accad">
<h1></h1>
<br>
<br>
