...
@section('title', 'Employee Statment')
@section('content')
<div class="content container-fluid">
	<div class="row">
		<div class="col-md-12 col-sm-12 col-lg-12 col-xl-12">
			<h4 class="card-title">Employee Statment</h4>
			<div class="card-box">
				<div class="card-block">
					@component('_components.alerts-default')
					@endcomponent
					<form method="POST" action="{{ route('employee-statement.store') }}" enctype = "multipart/form-data" id="upload_new_form">
						<div class="col-md-12">
							{{csrf_field()}}
							<div class="row">
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<select type="text" class="form-control employee_id" id="account"   name="employee_id"  placeholder="Name">
