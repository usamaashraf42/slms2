...
<div class="content container-fluid">
	<div class="row">
		...
		<div class="col-md-12 col-sm-12 col-lg-12 col-xl-12">
			<h4 class="card-title">Branch Performance</h4>
			<div class="card-box">
				...
				<div class="card-block">
					...
					@endcomponent
					<form method="POST" action="{{ route('branch-performance.store') }}" enctype = "multipart/form-data" id="upload_new_form">
						<div class="col-md-12">
							{{csrf_field()}}
							<div class="row">
								<div class="col-md-4">
							...
							<div class="form-group row">
								<label for="" class="col-sm-2 form-control-label">Report  </label>

								<div class="col-sm-2">
									<div class="checkbox">
								<input type="checkbox" class="checkbox_1" checked="" id="admissions" name="admissions" value="1"> <label for="admissions"> Admissions </label>
									</div>
								</div>
								<div class="col-sm-2">
									<div class="checkbox">
									<input type="checkbox" class="checkbox_1" checked="" name="leftStd" value="1"> 	<label for="leftStd"> Left Student </label>
									</div>
								</div>
								<div class="col-sm-2">
									<div class="checkbox">
										<input type="checkbox" class="checkbox_1" checked="" name="transStd" value="1">  <label for="transStd">Transfer Student </label>
									</div>
								</div>
